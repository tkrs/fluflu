...
class MessageUnpackerBenchmark extends TestData {
  ...
  @Benchmark
  def decodeString100_10: Either[Error, String10] =
    unpacker(`string 100 10`.duplicate()).decode[String10]
  ...
  @Benchmark
  def decodeString100_30: Either[Error, String30] =
    unpacker(`string 100 30`.duplicate()).decode[String30]

  @Benchmark
  def decodeString1000_30: Either[Error, String30] =
    unpacker(`string 1000 30`.duplicate()).decode[String30]

  @Benchmark
  def decodeString1000_30_multibyte: Either[Error, String30] =
    unpacker(`string 1000 30 multibyte`.duplicate()).decode[String30]
