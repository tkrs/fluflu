...
class MessageUnpackerSpec extends WordSpec {
  ...
  "string16" should {
    "be decoded" in {
      ...
      val decoded = instance(a).decode[Json]
      assert(decoded === Either.right(Json.fromString("aaasssssssssssseeeeeeeeeeeeefffffzzzzzzzzggggggggggggggggggggggggrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr^./`@　ffeeeeeeeee000000000000fffffffffgggggあssffffffffffffffssssse&eeeeeeeeeeeeeeeeeeeeeeeeeeffffzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz8716666666666666∫f™")))
    }
  }
